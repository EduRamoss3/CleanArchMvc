...
namespace CleanArchMvc.DomainTests
{
    public class ProductUnitTest1
    {
        ...
        {
            Action action = () => { Product product = new Product("", "description description", 332, 2, null,1); };
        ...
        public void CreateProduct_WithInvalidSize_ResultObjectInvalidState()
        {
            ...
            Action action = () => { Product product = new Product(name, "description description", 322, 2, null,1); };
        ...
        public void CreateProduct_WithInvalidDescriptionSizeSmaller_ResultObjectInvalidState()
        {
            ...
            Action action = () => { Product product = new Product("Product Name", description, 332, 2, null,1); };
        ...
        {
            Action action = () => { Product product = new Product("Product Name", "Uma descrição sobre um produto em teste no qual estou usando xUnit para testes unitários", -1, 2, null,1); };
        ...
        {
            Action action = () => { Product product = new Product("Product Name", "Uma descrição sobre um produto em teste no qual estou usando xUnit para testes unitários", 332, -1, null,1); };
        ...
        public void CreateProduct_WithInvalidImageSize_ResultObjectInvalidState()
        {
            ...
            Action action = () => { Product product = new Product("Product Name", "Uma descrição sobre um produto em teste no qual estou usando xUnit para testes unitários", 332, 2, image,1); };
